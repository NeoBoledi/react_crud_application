            ...
            <div className='addcontainer'>
                <form onSubmit={handleEdit} action=''>
                    <div className='member_img'>
                        <img src={file} alt="" />
                        <input className='imgFile' accept='image/jpeg,image/png,image/jpg' type='file' onChange={handleFileChange} /><i className='fa fa-plus changeImage' aria-hidden='true'></i>
                    </div>
